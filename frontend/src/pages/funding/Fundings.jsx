...
const Fundings = () => {
    return (
        <>
            <section className="py-5" style={{ backgroundColor: 'var(--wp--preset--color--kenta-base-300)' }}>
                    ...
                    <div className="row">
                        <div className="col-md-6">
                            ...
                            <div className="d-flex flex-wrap">
                                <a className="btn btn-primary rounded-pill m-2" href="https://www.moncompteformation.gouv.fr/espace-public/comment-financer-ma-formation-utiliser-mon-solde-cpf" target="_blank" rel="noopener">Mon compte Formation</a>
                                <a className="btn btn-outline-primary rounded-pill m-2" href="formations">Je choisis ma formation</a>
                            </div>
                        </div>
                        <div className="col-md-6">
                            <figure className="image-container">
                                <img className="img-fluid rounded-3" src="https://myairportacademy.com/wp-content/uploads/2024/04/2-1.png" alt="Logo mon compte formation (CPF)" />
                            </figure>
                        </div>
                    </div>
                </div>
                ...
                <div className="container px-5">
                    <div className="row">
                        <div className="col-md-6 order-md-2">
                            <figure className="image-container">
                                <img className="img-fluid rounded-3" src="https://myairportacademy.com/wp-content/uploads/2024/04/3-1.png" alt="Logo France Travail" />
                            </figure>
                        </div>
                        <div className="col-md-6 order-md-1">
                            ...
                            <div className="d-flex flex-wrap">
                                <a className="btn btn-primary rounded-pill m-2" href="https://www.francetravail.fr/candidat/en-formation/mes-aides-financieres.html" target="_blank" rel="noopener">France Travail</a>
                                <a className="btn btn-outline-primary rounded-pill m-2" href="formations">Je choisis ma formation</a>
                            </div>
                        </div>
                    </div>
                ...
                <div className="container px-5">
                    <div className="row">
                        <div className="col-md-6">
                            ...
                            <div className="d-flex flex-wrap">
                                <a className="btn btn-primary rounded-pill m-2" href="https://www.unml.info/#" target="_blank" rel="noopener">Les Missions locales</a>
                                <a className="btn btn-outline-primary rounded-pill m-2" href="formations">Je choisis ma formation</a>
                            </div>
                        </div>
                        <div className="col-md-6">
                            <figure className="image-container">
                                <img className="img-fluid rounded-3" src="https://myairportacademy.com/wp-content/uploads/2024/04/RML_logo_verti_rvb.jpg" alt="Logo des missions locales" />
                            </figure>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-5" style={{ backgroundColor: 'var(--wp--preset--color--kenta-base-300)' }}>
                <div className="container px-5">
                    <div className="row">
                        <div className="col-md-6 order-md-2">
                            <figure className="image-container">
                                <img className="img-fluid rounded-3" src="https://myairportacademy.com/wp-content/uploads/2024/04/4-1.png" alt="Logo AGEFIPH" />
                            </figure>
                        </div>
                        <div className="col-md-6 order-md-1">
                            ...
                            <div className="d-flex flex-wrap">
                                <a className="btn btn-primary rounded-pill m-2" href="https://www.agefiph.fr/aides-handicap/aide-la-formation-des-personnes-handicapees-dans-le-cadre-du-parcours-vers-lemploi" target="_blank" rel="noopener">L'AGEFIPH</a>
                                <a className="btn btn-outline-primary rounded-pill m-2" href="formations">Je choisis ma formation</a>
                            </div>
                        </div>
                    </div>
                ...
                <div className="container px-5">
                    <div className="row">
                        <div className="col-md-6">
                            ...
                            <div className="d-flex flex-wrap">
                                <a className="btn btn-primary rounded-pill m-2" href="https://www.iledefrance.fr/decouvrir-le-fonctionnement-de-la-region/la-region-en-action/laction-regionale-pour-la-formation-professionnelle" target="_blank" rel="noopener">La région Ile-de-France</a>
                                <a className="btn btn-outline-primary rounded-pill m-2" href="formations">Je choisis ma formation</a>
                            </div>
                        </div>
                        <div className="col-md-6">
                            <figure className="image-container">
                                <img className="img-fluid rounded-3" src="https://myairportacademy.com/wp-content/uploads/2024/04/1-1.png" alt="Logo de la région Ile-de-France" />
                            </figure>
                        </div>
                    </div>
                </div>
            ...
            <section className="py-5" style={{ backgroundColor: 'var(--wp--preset--color--kenta-base-300)' }}>
                <div className="container px-5">
                    <div className="row">
                        <div className="col-md-6 order-md-2">
                            <figure className="image-container">
                                <img className="img-fluid rounded-3" src="https://myairportacademy.com/wp-content/uploads/2024/04/logo-cb.jpg" alt="Logo CB" />
                            </figure>
                        </div>
                        <div className="col-md-6 order-md-1">
